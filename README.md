...
1. `docker build -t ???goers/catchemall .`

2. `docker run -p 8080:8080 ???goers/catchemall`
...
Separate web pages would allow the search and presentation of individual ???s and the information we gathered about them, including third party data (project A) and twitter analysis (project C)
